...
async def generate_final_signal(
    ...
    """
    ایک حتمی، قابلِ عمل سگنل تیار کرتا ہے جو متعدد عوامل پر مبنی ایک جامع اسکورنگ ماڈل کا استعمال کرتا ہے۔
    """
    try:
        ...
        # بنیادی حکمت عملی کا نتیجہ چیک کریں
        ...
        # --- مرحلہ 3: حتمی فیصلہ ---
        confidence = max(0, min(99, total_score)) # اسکور کو 0-99 کی حد میں رکھیں
