def generate_reason(core_signal: str, pattern_data: dict, risk_status: str, news_impact: str, confidence: float, market_structure: dict) -> str:
    ...
    if core_signal == "buy":
        ...
        if market_structure.get("trend") == "uptrend": reason_parts.append("Market structure confirms the uptrend.")
        ...
        if market_structure.get("trend") == "downtrend": reason_parts.append("Market structure confirms the downtrend.")
    else:
