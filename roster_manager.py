...
def get_split_monitoring_roster(db: Session, active_symbols_to_check: Set[str]) -> Tuple[List[str], List[str]]:
    ...
    2.  **کوٹ کے لیے غیر فعال جوڑے:** وہ جوڑے جو بنیادی فہرست میں ہیں لیکن فعال نہیں ہیں (ان کی صرف فوری قیمت کی اپ ڈیٹ کافی ہے تاکہ مارکیٹ کی عمومی حالت کا اندازہ ہو)۔
    ...
    logger.info(f"   - قیمت اپ ڈیٹ کے لیے (غیر فعال بنیادی): {inactive_primary_pairs}")
