...
def cleanup_weekend_signals():
    ...
    db = SessionLocal()
    try:
        # ... (باقی کا کلین اپ فنکشن پہلے جیسا ہی ہے) ...
...
async def start_background_tasks():
    ...
    # ★★★ تبدیلی یہاں ہے ★★★
    scheduler.add_job(hunt_for_signals_job, IntervalTrigger(seconds=120), id="hunter_engine_job") # 3 منٹ سے 2 منٹ
...
async def startup_event():
    ...
    # ایپلیکیشن کے آغاز پر خبروں کا کیش فوری طور پر اپ ڈیٹ کریں
...
# ... (باقی تمام روٹس اور ایونٹس پہلے جیسے ہی رہیں گے) ...
