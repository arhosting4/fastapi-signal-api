...
class Candle(BaseModel):
    ...
    # یہ ویلیڈیٹر یقینی بنائے گا کہ API سے آنے والی سٹرنگ ویلیوز فلوٹ میں تبدیل ہو جائیں
...
class NewsArticle(BaseModel):
    ...
    source: str
    snippet: str
    published_at: str # اسے سٹرنگ کے طور پر رکھیں کیونکہ فارمیٹ مختلف ہو سکتا ہے
    impact: str
    entities: List[str]
...
class KeyStatusResponse(BaseModel):
    ...
    """
    guardian_keys_total: int
    hunter_keys_total: int
